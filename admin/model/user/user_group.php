...
class ModelUserUserGroup extends PT_Model
{
    ...
    public function getUserGroupId($user_group_name)
    {
        $query = $this->db->query("SELECT user_group_id FROM " . DB_PREFIX . "user_group WHERE name = '" . $this->db->escape((string)$user_group_name) . "'");
